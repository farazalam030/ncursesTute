...
Our EULA was last updated on 08\/07\/2023

Please read this End-User License Agreement carefully before Accpeting,
downloading or
...
You and the Company regarding the use of the Application. This EULA was
generated by
...
an Application Store\'s account to a Device, named DASH CLI 5.0

> "Application Store" means the digital distribution service operated and
developed by Apple Inc.

\(Apple App Store\) or Google Inc. \(Google Play Store\) by which the
...
can be posted, uploaded,

linked to or otherwise made available by You, regardless of the form of that
content.
...
Application Store with other family members by allowing them to view and
download each others\'
...
and other products services\) provided by a third-party that may be displayed,
included or made

available by the Application.

> "You" means the individual accessing or using the Application or the company,
or other legal entity

on behalf of which such individual is accessing or using the Application, as
applicable.
...
This Agreement is between You and the Company only and not with the Application
Store. Therefore, the

Company is solely responsible for the Application and its content. Although the
Application Store is not a

party to this Agreement, it has the right to enforce it against You as a third
party beneficiary relating to your

use of the Application.

Since the Application can be accessed and used by other users via, for example,
Family Sharing \/ Family

Group or volume purchasing, the use of the Application by those users is
...
commercially exploit the Application or make the Application available to any
third party.

> Remove, alter or obscure any proprietary notice \(including any notice of
copyright or trademark\) of

the Company or its affiliates, partners, suppliers or the licensors of the
Application.
...
out of or relating to the Application. To the extent the Company is required to
provide indemnification by

applicable law, the Company, not the Application Store, shall be solely
responsible for the investigation,

defense, settlement and discharge of any claim that the Application or your use
of it infringes any third party
...
Application or any service to which it connects, with or without notice and
...
of the Application, which may include patches, bug fixes, updates, upgrades and
other modifications.

Updates may modify or delete certain features and\/or functionalities of the
Application. You agree that the
...
deemed to constitute an integral part

of the Application, and \(ii\) subject to the terms and conditions of this
Agreement.

Maintenance and Support

The Company does not provide any maintenance or support for the download and use
of the Application.

To the extent that any maintenance or support is required by applicable law, the
Company, not the

Application Store, shall be obligated to furnish any such maintenance or
support.
...
compliance, legality, decency, quality

or any other aspect thereof. The Company does not assume and shall not have any
...
Company, in the event that you fail
...
and service providers, expressly
...
of performance, usage or

trade practice. Without limitation to the foregoing, the Company provides no
warranty or undertaking, and
...
operation or availability of the

Application, or the information, content, and materials or products included
thereon; \(ii\) that the Application

will be uninterrupted or error-free; \(iii\) as to the accuracy, reliability, or
currency of any information or

content provided through the Application; or \(iv\) that the Application, its
servers, the content, or e-mails sent
...
shall be applied to the greatest

extent enforceable under applicable law. To the extent any warranty exists under
law that cannot be

disclaimed, the Company, not the Application Store, shall be solely responsible
for such warranty.
...
limited to the amount actually paid by You for the Application or through the
Application or 100 USD if You
...
to use the Application, third-party
...
You expressly understand and agree that the Application Store, its subsidiaries
and affiliates, and its

licensors shall not be liable to You under any theory of liability for any
direct, indirect, incidental, special

consequential or exemplary damages that may be incurred by You, including any
loss of data, whether or

not the Application Store or its representatives have been advised of or should
...
performance of an obligation under

this Agreement shall not effect a party\'s ability to exercise such right or
require such performance at any

time thereafter nor shall the waiver of a breach constitute a waiver of any
subsequent breach.

Product Claims

The Company does not make any warranties concerning the Application. To the
extent You have any claim

arising from or relating to your use of the Application, the Company, not the
Application Store, is

responsible for addressing any such claims, which may include, but not limited
to: \(i\) any product liability
...
this Agreement at any time. If a
...
effective, You agree to be bound
...
Application. Your use of the Application may also be subject to other local,
...
Company\'s services, which the Company will provide to You at the time of such
use or purchase.
...
> By visiting this page on our website: amd.com

> By sending us an email: help@amd.com
*/